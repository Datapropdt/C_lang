...
1. while() { ..... } - is an entry condition checking or pretest loop or entry
		     controlled. no minimum times when condition false.
		     must not be terminated with ;
2. do { .... } while(); - is exit condition checking or post test loop or
		 exit controlled loop runs min 1 time irrespective of condition.
